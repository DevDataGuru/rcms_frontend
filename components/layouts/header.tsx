...
import { FaAt, FaPrint, FaTasks } from "react-icons/fa";
...
const Header = () => {
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      dispatch(SaveUserDetail(decodedUser));
    }
  }, [dispatch]);
  useEffect(() => {
  ...
  const profileImage = useSelector(
    (state: IRootState) => state.user.userDetail
  );
  useEffect(() => {
    if (userData && userData?.userData?.accessToken) {
      localStorage.setItem("user", userData?.userData?.accessToken);
    }
  }, []);
  const isRtl =
  ...
  return (
    ...
    >
      <div className="shadow-sm">
        <div className="relative bg-white  backdrop-blur-lg flex w-full items-center px-5 py-2.5 dark:bg-black">
          ...
          <div className=" ltr:mr-2 rtl:ml-2 sm:block">
            <ul className="flex items-center space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
              <li>
                <Link
                  href="#"
                  className="block rounded-full text-black bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60"
                >
                  <FaAt />
                </Link>
              </li>
          ...
          <div className="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
            ...
            <div>
              {themeConfig.theme === "light" ? (
                <button
                  className={`${
                    themeConfig.theme === "light" &&
                    "flex items-center rounded-full text-black  bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60"
                  }`}
            ...
            <div className="dropdown shrink-0">
              ...
              >
                <ul className="grid w-[280px] grid-cols-2 gap-2 !px-2 font-semibold text-dark dark:text-black dark:text-white-light/90">
            ...
            <div className="dropdown shrink-0">
              <Dropdown
                offset={[0, 8]}
                placement={`${isRtl ? "bottom-start" : "bottom-end"}`}
                btnClassName="block p-2 rounded-full text-black bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60"
                button={<IconMailDot />}
              >
            ...
            <div className="dropdown shrink-0">
              <Dropdown
                offset={[0, 8]}
                placement={`${isRtl ? "bottom-start" : "bottom-end"}`}
                btnClassName="relative block p-2 text-black rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60"
                button={
                  <span>
                    <IconBellBing />
              ...
              >
                <ul className="w-[300px] divide-y !py-0 text-white dark:divide-white/10 dark:text-white-dark sm:w-[350px]">
                  <li onClick={(e) => e.stopPropagation()}>
