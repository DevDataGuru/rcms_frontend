...
const CommponentExpenseForm = ({ setUserRole }) => {
                ...
                <div className="flex flex-wrap justify-between px-4">
                    <div className="grid flex-1 grid-cols-2 gap-5 sm:grid-cols-2 p-4  dark:border-[#191e3a] dark:bg-black">
                        ...
                        <div className="form-group flex items-center">
                            ...
                            <input id="reciever-email" type="text" name="reciever-email" className="form-input flex-1" />
                        </div>
                        <div className="form-group flex items-center">
            ...
            <div className="mt-6 w-full xl:mt-0 xl:w-96">
                <div className="panel mb-5">
                    ...
                    <div className="mt-4 flex items-center">
                        ...
                        <input id="reciever-number" type="date" name="reciever-number" className="form-input flex-1" />
                    </div>
...
export default CommponentExpenseForm;
