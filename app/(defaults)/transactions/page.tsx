                ...
                <>
                    ...
                    <div>
                        <form className="mb-5 rounded-md border border-[#ebedf2] bg-white p-4 dark:border-[#191e3a] dark:bg-black">
                            <h6 className="mb-5 text-lg font-bold">ADD NEW Transactions</h6>
                            ...
                            <div className="flex flex-col sm:flex-row">
                                ...
                                <div className="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2 p-4 bg-yellow-50 dark:border-[#191e3a] dark:bg-black">
                                    ...
                                    <div>
                                        <label htmlFor="profile_category">Transaction Target Type*</label>
                                        <div className="relative">
                                            <select
                                                id="profile_category"
                                            ...
                                            >
                                                <option value="">Select Transaction Target Type*</option>
                                                <option value="Individual">Companies</option>
                                                <option value="Business">Vehicles</option>
                                                <option value="Professional">Employee</option>
                                                <option value="Enterprise">Company bank account</option>
                                            </select>
                                            {errors.profile_type && (
                                                <FaExclamationCircle
                                                    className="absolute top-1/2 right-2 transform -translate-y-1/2 text-red-500"
                                    ...
                                    <div>
                                        <label htmlFor="profile_category">Transaction Type</label>
                                        <div className="relative">
                                            <select
                                                id="profile_category"
                                                className={`form-select ${errors.profile_type ? "border-red-500" : ""}`}
                                            ...
                                            >
                                                ...
                                                <option value="Individual">cash box</option>
                                                <option value="Business">petty cash</option>
                                                <option value="Professional">Bank accounts</option>
                                            </select>
                                            {errors.profile_type && (
                                                <FaExclamationCircle
                                                    className="absolute top-1/2 right-2 transform -translate-y-1/2 text-red-500"
                                    ...
                                    <div>
                                        <label htmlFor="profile_category">Companies</label>
                                        <div className="relative">
                                            <select
                                                id="profile_category"
                                                className={`form-select ${errors.profile_type ? "border-red-500" : ""}`}
                                    ...
                                    <div>
                                        <label htmlFor="profile_category">Type*</label>
                                        <div className="relative">
                                            <select
                                                id="profile_category"
                                                className={`form-select ${errors.profile_type ? "border-red-500" : ""}`}
                                    ...
                                    <div>
                                        <label htmlFor="profile_category">Category*</label>
                                        <div className="relative">
                                            <select
                                                id="profile_category"
                                                className={`form-select ${errors.profile_type ? "border-red-500" : ""}`}
                                            ...
                                            >
                                                ...
                                                <option value="Cheque">Amount out (-)</option>
                                            </select>
                                            {errors.profile_type && (
                                                <FaExclamationCircle
                                                    className="absolute top-1/2 right-2 transform -translate-y-1/2 text-red-500"
                                    ...
                                    <div>
                                        <label htmlFor="profile_category">Payment Method</label>
                                        <div className="relative">
                                            <select
                                                id="profile_category"
                                                className={`form-select ${errors.profile_type ? "border-red-500" : ""}`}
                                    ...
                                    <div>
                                        <label htmlFor="name">Bank reference number</label>
                                        <div className="relative">
                                            <input
                                                id="name"
                                                type="text"
                                    ...
                                    <div>
                                        <label htmlFor="name">Cheque No</label>
                                        <div className="relative">
                                            <input
                                                id="name"
                                                type="text"
                                    ...
                                    <div>
                                        <label htmlFor="name">Cheque Date</label>
                                        <div className="relative">
                                            <input
                                                id="name"
                                                type="date"
